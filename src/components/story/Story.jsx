            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-12">
                <p>
                  ...
                  <strong>click &quot;4444444Reservation&quot; button</strong>{" "}
                  on the top right to see the pop-up reservation form.
                </p>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-12">
                <div className="team-thumb">
                  <img
                    src="../src/assets/team/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg"
              ...
              <div className="col-lg-4 col-12 my-lg-0 my-4">
                <div className="team-thumb">
                  <img
                    src="../src/assets/team/nicolas-horn-MTZTGvDsHFY-unsplash.jpg"
                    className="img-fluid team-image"
                    alt=""
                  />
              ...
              <div className="col-lg-4 col-12">
                <div className="team-thumb">
                  <img
                    src="../src/assets/team/rc-cf-FMh5o5m5N9E-unsplash.jpg"
                    className="img-fluid team-image"
                    alt=""
                  />
        ...
        <section className="newsletter section-padding bg-white">
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-12">
                <img
                  src="../src/assets/charles-deluvio-FdDkfYFHqe4-unsplash.jpg"
