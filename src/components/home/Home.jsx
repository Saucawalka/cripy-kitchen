...
import img1 from '../../assets/slide/jay-wennington-N_Y88TWmGwA-unsplash.jpg'
import img2 from '../../assets/slide/jason-leung-O67LZfeyYBk-unsplash.jpg'
import img3 from '../../assets/slide/ivan-torres-MQUqbmszGGM-unsplash.jpg'
import vid from '../../assets/video/production_ID_3769033.mp4'
...
const Home = () => {
  ...
  const endpoint='http://localhost:5000/info/home'
  // const getFood= 'http://localhost:5000/info/food'
  useEffect(() => {
    // Play the video if the ref is set
    if (videoRef.current) {
